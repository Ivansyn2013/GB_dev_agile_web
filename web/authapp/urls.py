...
urlpatterns = [
    ...
    path('request_friends/<int:friends_id>/', views.request_friends, name='request_friends'),
    path('delete_request_friends/<int:friend_id>/', views.delete_request_friend),
    path('done_cancel_friend/<int:friend_id>/<str:status>/', views.done_cancel_friends, name='done_cancel_friends'),
